...
app.controller('BasicController', function($scope) {
  console.log('BasicController works!');
  ...
  self.totalSalary = function() {
    self.salaries = 0;
    self.employees.forEach( function (employee) {
      self.salaries += employee.salary;
    });

  };

  self.createEmployee = function () {
    if (self.employee.firstName != undefined &&
        self.employee.lastName != undefined &&
        self.employee.idNumber != undefined &&
        self.employee.jobTitle != undefined &&
        self.employee.salary != undefined) {
  ...
  self.fireEmployee = function ($index) {
